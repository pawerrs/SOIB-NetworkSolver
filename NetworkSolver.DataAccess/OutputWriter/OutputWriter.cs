...
namespace NetworkSolver.DataAccess.OutputWriter
{
    public class OutputWriter
    {
        ...
        {
            string _filePath = $"{Directory.GetParent(Directory.GetParent(Directory.GetParent(Directory.GetParent(AppDomain.CurrentDomain.BaseDirectory).FullName).FullName).FullName).FullName}\\NetworkSolutions\\{fileName}";
            using StreamWriter fileStream = CreateFile(_filePath);
